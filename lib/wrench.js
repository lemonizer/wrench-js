 ...
 */
exports.readdirSyncRecursive = function(baseDir, opts) {
    ...
    var readdirSyncRecursive = function(baseDir) {
        var files = [],
            ...
            isDir = function(fname){
                var stat;
                if(opts.followSymDir){
                    stat = fs.statSync( _path.join(baseDir, fname) );
                }else{
                    stat = fs.lstatSync( _path.join(baseDir, fname) );
                }
 ...
 *
 */
exports.readdirRecursive = function(baseDir, opts, fn) {
    ...
    function readdirRecursive(curDir) {
        ...
        fs.readdir(curDir, function(e, curFiles) {
            ...
            curFiles.forEach(function(it) {
                ...
                var statfn = opts.followSymDir ? fs.stat : fs.lstat;

                statfn(it, function(e, stat) {
                    waitCount--;
